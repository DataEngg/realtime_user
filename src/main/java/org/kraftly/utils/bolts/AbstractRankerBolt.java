...
import org.kraftly.utils.tools.Rankings;
...
public abstract class AbstractRankerBolt extends BaseBasicBolt {
    ...
    private static final Logger LOG = Logger.getLogger(AbstractRankerBolt.class);
    ...
    private void emitRankings(BasicOutputCollector collector) {
        LOG.info("Final Rankings Value is "+ rankings.copy().toString());
